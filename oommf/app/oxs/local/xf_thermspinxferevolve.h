...
private:
  ...
  **/
  mutable OC_INT4m ranIntIndex, ranIntStream; // persistent variables of the random number generator
  mutable OC_INT4m ranIntArray[97];			     // that must be kept for the next call of this function
