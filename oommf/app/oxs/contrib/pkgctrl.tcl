...
set EXCLUDEPKG [list CVS newcontrib]

# Files to exclude from package list
...
# USAGE
proc Usage {} {
   puts stderr "Usage: pkgctrl list"
   puts stderr "  or   pkgctrl listfiles pkg \[pkg ...\]"
   puts stderr "  or   pkgctrl install \[-v\] \[-nopatch\] pkg \[pkg ...\]"
   puts stderr "  or   pkgctrl uninstall pkg \[pkg ...\]"
   puts stderr "  or   pkgctrl copyout   pkg \[pkg ...\] destination"
   puts stderr "Wildcards accepted in pkg specifications."
   exit 255
}
