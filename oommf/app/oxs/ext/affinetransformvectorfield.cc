/* FILE: affinetransformvectorfield.cc      -*-Mode: c++-*-
 *
...
#include "meshvalue.h"
#include "director.h"
#include "affinetransformvectorfield.h"

// Oxs_Ext registration support
OXS_EXT_REGISTER(Oxs_AffineTransformVectorField);

/* End includes */

// Constructor
Oxs_AffineTransformVectorField::Oxs_AffineTransformVectorField(
...
void
Oxs_AffineTransformVectorField::InvertMatrix
(Oxs_Ext* obj,
 Oxs_ThreeVector& A1,
 Oxs_ThreeVector& A2,
 Oxs_ThreeVector& A3,
...
void
Oxs_AffineTransformVectorField::Value
(const ThreeVector& pt,ThreeVector& value) const
{
  // Evaluate field at pt
  ThreeVector tmpval;
  field->Value(pt,tmpval);

  // Apply transform to value
  value = ThreeVector(row1*tmpval,row2*tmpval,row3*tmpval);
  value += offset;
}
