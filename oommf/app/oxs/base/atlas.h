...
public:
  ...
  virtual OC_BOOL GetRegionExtents(OC_UINT4m id,Oxs_Box &mybox) const =0;
  ...
  virtual OC_INT4m GetRegionId(const ThreeVector& point) const =0;
  ...
  virtual OC_INT4m GetRegionId(const String& name) const =0;
  ...
  virtual OC_BOOL GetRegionName(OC_UINT4m id,String& name) const =0;
  ...
  virtual OC_UINT4m GetRegionCount() const =0;
